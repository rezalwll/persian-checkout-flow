...
This note records the decision behind **checkout** behavior in component-patterns.
...
Use a small, independently testable function for the virtualized path. Keep input normalization at the boundary and return a neutral value for missing samples.
...
Review marker: decision 245 in the project evolution.
