...
This note records the decision behind **layout** behavior in component-patterns.
...
Use a small, independently testable function for the stable path. Keep input normalization at the boundary and return a neutral value for missing samples.
...
Review marker: decision 82 in the project evolution.
